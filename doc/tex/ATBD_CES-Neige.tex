...
pdftitle=Algorithm theoritical basis documentation for an operational snow cover product from Sentinel-2 and Landsat-8 data (Let-it-snow)}
\tolerance=1000
...
\item cloud mask 
\item flat surface reflectances (red, MIR)
\end{itemize} };
